...
const Clips = ({ imgsrc, clip }) => {
  return (
    <>
      <div
        className="relative h-28 w-32 rounded-xl 
      ...
      >
        ...
        />
        <div
          className="bg-white blur-effect-theme 
        absolute top-11 left-11 lg:top-8 lg:left-9 sm:top-4 sm:left-5 right-0 opacity-100
