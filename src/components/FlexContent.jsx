...
const FlexContent = ({
  ...
  return (
    <>
      <div
        className={`flex items-center justify-center lg:flex-col lg:justify-center
      ...
      >
        ...
        <div className="flex items-center justify-center max-w-xl lg:max-w-none w-full relative">
          <img
            ...
            ${
              ifExists
                ? 'h-60 lg:h-56 md:h-52 sm:h-44 xsm:h-36 rotate-6 hover:-rotate-6'
                : 'h-72 lg:h-64 md:h-60 sm:h-48 xsm:h-40 rotate-6 hover:-rotate-6'
            }`}
          />
        </div>
      </div>
